CC = g++
CFLAGS = -Wall -Wextra -pedantic -g#-Ofast#-g
...
python: montecarlo.cpp 
	$(CC) -c -I/usr/include/python3.8/ -I/usr/include/numpy/ -lpython3.8 -lnumpy -g -Wall -fpic -pedantic -lm montecarlo.cpp montecarlomodule.cpp
